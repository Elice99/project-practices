...
__all__ = [
    'DISPID_SBSWrite', 'SVP_14', 'SPEI_PHONEME',
    'DISPID_SRGCmdSetRuleState', 'SpeechGrammarWordType',
    'SPAUDIOSTATUS', 'DISPID_SMSSetData', 'ISpeechPhraseAlternates',
    'SPSEMANTICERRORINFO', 'DISPID_SRProfile', 'SPPS_Interjection',
    'ISpRecognizer3', 'SPBOOKMARKOPTIONS', 'DISPID_SRCEEnginePrivate',
    'DISPID_SDKSetBinaryValue', 'DISPID_SVSpeakCompleteEvent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE5',
    'SAFTGSM610_22kHzMono', 'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechPhraseRules', 'DISPID_SLWsItem',
    'ISpeechGrammarRuleStateTransition', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRTLength', 'SPXRO_SML',
    'SAFT11kHz8BitMono', 'DISPID_SRGRecoContext',
    'DISPID_SGRAddResource', 'DISPID_SpeechVoiceStatus',
    'SRTSMLTimeout', 'ISpeechGrammarRule',
    'SpeechStreamSeekPositionType', 'SRERequestUI', 'SREPhraseStart',
    'DISPID_SPRDisplayAttributes', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCEEndStream', 'DISPID_SpeechVoiceEvent',
    'SRADefaultToActive', 'SAFTText', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEFalseRecognition', 'SDA_No_Trailing_Space',
    'SREAudioLevel', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVSPhonemeId',
    'SP_VISEME_6', 'SpeechCategoryPhoneConverters',
    'SDA_Two_Trailing_Spaces', 'DISPID_SVSInputSentencePosition',
    'SpeechLexiconType', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPPName', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVEBookmark', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCESoundStart',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechRecognizerStatus', 'SPBINARYGRAMMAR', 'SITooSlow',
    'DISPID_SPIAudioSizeTime', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPIProperties', 'SRARoot', 'DISPID_SRRAlternates',
    'SPINTERFERENCE_TOOLOUD', 'SWPUnknownWordUnpronounceable',
    'ISpShortcut', '_ISpeechVoiceEvents', 'SPEI_END_SR_STREAM',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRCERecognition',
    'DISPID_SpeechRecoContext', 'SPAS_CLOSED', 'DISPID_SFSClose',
    'SpeechVoiceSpeakFlags', 'SpNotifyTranslator',
    'DISPID_SPIGetText', 'eLEXTYPE_USER', 'SGDisplay',
    'eLEXTYPE_RESERVED8', 'STCInprocServer',
    'DISPID_SRCVoicePurgeEvent',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SINone',
    'DISPID_SDKOpenKey', 'DISPID_SREmulateRecognition',
    'SVSFParseMask', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SP_VISEME_11', 'DISPID_SPPFirstElement', 'SDKLLocalMachine',
    'SpSharedRecoContext', 'SREStateChange', 'SPCT_SUB_DICTATION',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTGSM610_44kHzMono',
    'SVPAlert', 'DISPID_SpeechXMLRecoResult', 'SVP_7',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechFileStream',
    'DISPID_SRGetPropertyString', 'SPPS_Unknown',
    'DISPID_SOTGetStorageFileName', 'SPLOADOPTIONS',
    'SpeechWordPronounceable', 'DISPID_SOTMatchesAttributes',
    'SpeechDiscardType', 'SPEI_SOUND_START', 'SP_VISEME_8',
    'SPBO_AHEAD', 'DISPID_SPRuleParent', 'DISPID_SPPEngineConfidence',
    'DISPID_SGRsDynamic', 'DISPID_SpeechPhraseProperties',
    'SAFT8kHz16BitMono', 'DISPID_SRRSaveToMemory',
    'SpeechVoiceSkipTypeSentence', 'SPEI_START_SR_STREAM',
    'DISPID_SRRSpeakAudio', 'DISPID_SPERetainedStreamOffset',
    'SPINTERFERENCE_NOSIGNAL', 'SPEI_VOICE_CHANGE',
    'DISPID_SAEventHandle', 'SPEI_RESERVED5', 'DISPID_SPACommit',
    'SPFILEMODE', 'SpeechRetainedAudioOptions',
    'DISPID_SRCRequestedUIType', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPVPRIORITY', 'SPEI_RECOGNITION', 'SPEVENTENUM',
    'SECFNoSpecialChars', 'SPAUDIOOPTIONS', 'SP_VISEME_4',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVAudioOutput', 'SECFDefault',
    'ISpEventSink', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVResume', 'ISpRecoContext',
    'DISPID_SASNonBlockingIO', 'SpeechRegistryUserRoot',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechMemoryStream', 'ISpeechObjectTokenCategory',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechPhraseRule',
    'DISPID_SOTRemoveStorageFileName', 'SFTSREngine',
    'SpeechVisemeType', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFT16kHz8BitMono',
    'DISPID_SPPParent', 'DISPID_SPIEngineId', 'SVPNormal', 'SVPOver',
    'ISpeechPhraseInfoBuilder', 'SRAImport', 'SRSEIsSpeaking',
    'SPSNoun', 'SGRSTTTextBuffer', 'ISpXMLRecoResult',
    'DISPID_SRCEStartStream', 'DISPID_SGRAddState',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFT12kHz8BitStereo', 'DISPID_SRState', 'ISpRecoResult',
    'SPEI_FALSE_RECOGNITION', 'SRAONone', 'SPPS_RESERVED3',
    'DISPID_SDKDeleteKey', 'DISPID_SASetState', 'SP_VISEME_21',
    'DISPID_SRGCmdLoadFromObject', 'SRCS_Disabled',
    'SpeechEmulationCompareFlags', 'SpeechVisemeFeature',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRAttributes', 'DISPID_SRDisplayUI', 'SP_VISEME_0',
    'SPVPRI_NORMAL', 'DISPID_SAVolume',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRPhraseInfo',
    'ISpDataKey', 'SP_VISEME_18', 'SDTReplacement', 'SVSFIsXML',
    'SpStream', 'DISPID_SRGSetTextSelection',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechDataKey',
    'ISpRecognizer', 'SVEPrivate', 'DISPID_SLAddPronunciation',
    'DISPID_SRGetPropertyNumber', 'DISPID_SGRClear',
    'DISPID_SLPs_NewEnum', 'SpeechTokenIdUserLexicon', 'SPVISEMES',
    'SAFTDefault', 'SAFTExtendedAudioFormat',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SDKEnumValues', 'SBONone',
    'SWPUnknownWordPronounceable', 'DISPID_SVPause', 'DISPID_SPIRule',
    'ISpeechMemoryStream', 'SVEVoiceChange', 'ISpeechGrammarRules',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPPsCount',
    'SpeechDisplayAttributes', 'ISpeechPhraseRule',
    'ISpeechPhraseReplacement', 'DISPID_SRAudioInputStream',
    'SVEAudioLevel', 'SPPS_Function', 'SAFT11kHz16BitStereo',
    'ISpeechLexiconPronunciations', 'DISPID_SGRsFindRule',
    'SSSPTRelativeToCurrentPosition', 'ISpeechResourceLoader',
    'DISPID_SRRTStreamTime', 'SSSPTRelativeToEnd',
    'DISPID_SRGetFormat', 'DISPID_SpeechPhoneConverter',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_PRIVATE17',
    'SPINTERFERENCE_NONE', 'DISPID_SVGetAudioOutputs',
    'SPEI_REQUEST_UI', 'SPAUDIOBUFFERINFO', 'ISpeechRecognizerStatus',
    'DISPID_SRCResume', 'DISPID_SABufferNotifySize',
    'SAFT11kHz8BitStereo', 'SREPropertyNumChange', 'SpLexicon',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCVoice', 'SpeechDictationTopicSpelling', 'SGLexical',
    'SPRS_INACTIVE', 'DISPID_SRAudioInput', 'SAFT24kHz8BitMono',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCEPhraseStart',
    'ISpRecoContext2', 'SVP_9', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SGRSTRule', 'SPEI_HYPOTHESIS', 'ISpSerializeState',
    'SpCustomStream', 'eLEXTYPE_LETTERTOSOUND', 'SPEI_MIN_TTS',
    'SPEI_ADAPTATION', 'SpFileStream', 'DISPID_SRRGetXMLErrorInfo',
    'SRERecognition', 'DISPID_SpeechAudioStatus',
    'DISPID_SRSNumberOfActiveRules', 'SPCS_DISABLED',
    'DISPID_SLWLangId', 'DISPID_SPILanguageId', 'DISPID_SOTCDefault',
    'DISPID_SVRate', 'DISPID_SpeechLexiconPronunciation',
    'SGRSTTRule', 'DISPID_SpeechPhraseElements', 'SDTDisplayText',
    'SPLO_STATIC', 'SPPS_RESERVED1', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPEDisplayText', 'DISPID_SGRs_NewEnum',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPPsItem',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRSTWeight', 'STCAll',
    'ISpeechXMLRecoResult', 'SP_VISEME_1', 'SPGRAMMARSTATE',
    'IInternetSecurityMgrSite', 'ISpeechRecognizer', 'SVEViseme',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRCEInterference',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPRsItem',
    'DISPID_SRCEventInterests', '__MIDL_IWinTypes_0009',
    'DISPID_SRCRecognizer', 'DISPID_SVESentenceBoundary',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechBaseStream',
    'DISPID_SGRSTType', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechWordType', 'eLEXTYPE_PRIVATE15', 'SpMMAudioOut',
    'DISPID_SpeechAudioFormat', 'eLEXTYPE_PRIVATE6', 'SRTAutopause',
    'DISPID_SpeechGrammarRules', 'SAFTNoAssignedFormat', 'ISpStream',
    'DISPID_SPEAudioStreamOffset', 'SRTStandard',
    'DISPID_SRGSetWordSequenceData', 'SSFMCreateForWrite',
    'SP_VISEME_5', 'SP_VISEME_12', 'ISpRecognizer2', 'SPRULESTATE',
    'DISPID_SLRemovePronunciation', 'Speech_Default_Weight',
    'DISPID_SVStatus', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechPhraseInfo', 'DISPID_SLGetGenerationChange',
    'DISPID_SRCEAudioLevel', 'DISPID_SRGRules',
    'DISPID_SRGetRecognizers', 'SPFM_CREATE', 'SVP_4',
    'DISPID_SCSBaseStream', 'SpeechRecoEvents',
    'DISPID_SLWPronunciations', 'DISPID_SGRSTText',
    'ISpNotifyTranslator', 'STSF_LocalAppData',
    'DISPID_SOTIsUISupported', 'SPPS_Verb', 'LONG_PTR',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_10',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechAddRemoveWord',
    'SpeechCategoryAudioOut', 'SECFIgnoreCase',
    'DISPID_SABIEventBias', 'DISPID_SPEAudioSizeBytes',
    'SPSNotOverriden', 'DISPID_SGRsCount', 'SRSInactive',
    'DISPID_SpeechPhraseProperty', 'DISPID_SMSADeviceId',
    'DISPID_SGRSRule', 'SpMMAudioEnum', 'SpeechTokenKeyAttributes',
    'eLEXTYPE_PRIVATE19', 'SPEI_TTS_PRIVATE', 'SVSFNLPMask',
    'SASClosed', 'SPCT_COMMAND', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechRecoResultDispatch',
    'DISPID_SLAddPronunciationByPhoneIds', 'SECFEmulateResult',
    'SpeechCategoryAudioIn', 'SAFT22kHz16BitMono',
    'Speech_StreamPos_RealTime', 'SAFT32kHz16BitMono',
    'SAFT48kHz16BitMono', 'SPEI_WORD_BOUNDARY', 'eLEXTYPE_PRIVATE14',
    'SpAudioFormat', 'DISPID_SGRsAdd', 'tagSPTEXTSELECTIONINFO',
    'SpeechStreamFileMode', 'eLEXTYPE_PRIVATE11',
    'IInternetSecurityManager', 'DISPID_SPANumberOfElementsInResult',
    'ISpeechLexiconPronunciation', 'DISPID_SOTCEnumerateTokens',
    'SPLO_DYNAMIC', 'DISPID_SLPLangId', 'SDTProperty',
    'SPPS_SuppressWord', 'DISPID_SpeechObjectToken',
    'IEnumSpObjectTokens', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SGRId', 'DISPID_SVGetAudioInputs', 'SREStreamEnd',
    'DISPID_SPEs_NewEnum', 'eLEXTYPE_PRIVATE7',
    'SpeechBookmarkOptions', 'SP_VISEME_13', 'SPSHT_OTHER',
    'DISPID_SLWsCount', 'DISPID_SRCState', 'SGRSTTDictation',
    'SPPS_RESERVED4', 'SREAllEvents', 'DISPID_SPRulesItem',
    'ISpeechObjectToken', 'DISPID_SRRAudioFormat',
    'DISPID_SOTDisplayUI', 'SPWORDTYPE', 'DISPID_SLGetPronunciations',
    'DISPID_SPISaveToMemory', 'SVP_11',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_10',
    'SAFT24kHz16BitMono', 'DISPID_SRRTimes', 'DISPID_SRGReset',
    'SASRun', 'WAVEFORMATEX', 'SPSHT_NotOverriden', 'SSTTDictation',
    'SSTTWildcard', 'SPEI_TTS_AUDIO_LEVEL', 'SPPHRASERULE',
    'ISpeechPhraseRules', 'DISPID_SPIReplacements', 'DISPID_SGRsItem',
    'SpeechVoicePriority', 'SAFT22kHz8BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPIDSPRG',
    'SAFTADPCM_44kHzMono', 'DISPID_SLPsCount',
    'DISPID_SpeechRecognizer', 'DISPID_SLWs_NewEnum',
    'ISpObjectWithToken', 'DISPID_SPPNumberOfElements',
    'DISPID_SPPs_NewEnum', 'SRTReSent', 'SAFTADPCM_8kHzMono',
    ...
    'SPEI_RESERVED2', 'SPEI_RESERVED6', 'ISpeechAudioBufferInfo',
    'DISPID_SPIStartTime', 'DISPID_SOTGetAttribute',
    'DISPID_SPCPhoneToId', 'STCLocalServer', 'SVP_3',
    'SpeechGrammarTagWildcard', 'ISpeechRecoResultTimes',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseElement',
    'SPDKL_DefaultLocation', 'ISpObjectToken',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE2', 'SVSFVoiceMask',
    'DISPID_SRSAudioStatus', 'SpeechCategoryRecoProfiles',
    'SAFT48kHz8BitStereo', 'DISPID_SRRecognizer',
    'SAFTCCITT_uLaw_44kHzStereo', 'SDTAll', 'SASStop',
    'SECNormalConfidence', 'SVEStartInputStream', 'SRSActiveAlways',
    'SPRECOSTATE', 'SREBookmark', 'SREHypothesis',
    'DISPID_SVSyncronousSpeakTimeout', 'eLEXTYPE_PRIVATE1',
    'DISPID_SDKGetlongValue', 'IEnumString', 'SVSFlagsAsync',
    'SPPS_Noun', 'DISPID_SPELexicalForm', 'SpeechEngineProperties',
    'SpeechRunState', 'SP_VISEME_9', 'SpInprocRecognizer',
    'SDKLDefaultLocation', 'SAFT22kHz16BitStereo',
    'DISPID_SGRSTNextState', 'SPVPRI_ALERT', 'SPSUnknown',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SDKDeleteValue',
    'DISPID_SLGenerationId', 'ISpGrammarBuilder',
    'ISpeechPhraseProperties', 'DISPID_SVGetProfiles', 'tagSTATSTG',
    'DISPID_SPEsCount', 'SpeechRecoProfileProperties',
    'DISPID_SRCPause', 'DISPID_SOTSetId', 'SAFTADPCM_8kHzStereo',
    'DISPID_SGRSTs_NewEnum', 'UINT_PTR', '_RemotableHandle',
    'SVF_Stressed', 'SAFT32kHz8BitMono', 'SPDKL_LocalMachine',
    'SPCONTEXTSTATE', 'DISPID_SRCESoundEnd', 'SAFTNonStandardFormat',
    'SpeechRecognitionType', 'SGDSActive', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPFM_OPEN_READWRITE', 'SPGRAMMARWORDTYPE', 'SVF_Emphasis',
    'SPSInterjection', 'SVSFUnusedFlags', 'eLEXTYPE_RESERVED4',
    'DISPID_SDKCreateKey', 'DISPID_SOTCategory',
    'DISPID_SpeechLexiconWord', 'DISPID_SFSOpen', 'DISPID_SPRText',
    'SP_VISEME_2', 'DISPID_SGRSTransitions', 'SpPhoneConverter',
    'SAFT48kHz8BitMono', 'SAFTADPCM_44kHzStereo', 'SPRECORESULTTIMES',
    'DISPID_SOTCId', 'ISpPhrase', 'DISPID_SVEAudioLevel',
    'DISPID_SLPSymbolic', 'SREAdaptation', 'DISPID_SWFEFormatTag',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRSTsItem',
    'DISPID_SPRuleConfidence', 'SPEVENTSOURCEINFO',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRCBookmark',
    'DISPID_SPRuleEngineConfidence', 'SpeechPartOfSpeech',
    'SECLowConfidence', 'DISPID_SVSkip', 'SAFT16kHz8BitStereo',
    'SPWT_DISPLAY', 'DISPID_SPEAudioTimeOffset', 'DISPID_SVSVisemeId',
    'SpResourceManager', 'DISPID_SpeechPhraseBuilder', 'SVP_16',
    'SPINTERFERENCE_TOOQUIET', 'SAFTGSM610_11kHzMono',
    'SGDSActiveUserDelimited', 'SVP_17', 'SSFMCreate',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechPhraseElement',
    'SITooLoud', 'SRAExport', 'DISPID_SRRDiscardResultInfo',
    'ISpStreamFormatConverter', 'SPCT_SLEEP',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpSharedRecognizer',
    'STSF_AppData', 'Speech_Max_Word_Length', 'SVSFDefault',
    'SAFT44kHz8BitStereo', 'SSFMOpenReadWrite', 'DISPID_SVPriority',
    'SSSPTRelativeToStart', 'SpeechSpecialTransitionType',
    'SAFTCCITT_uLaw_8kHzStereo', 'SLODynamic', 'ISpEventSource',
    'SpeechFormatType', 'eLEXTYPE_APP',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPEAudioSizeTime',
    'DISPID_SGRName', 'SECFIgnoreKanaType', 'ISpObjectTokenCategory',
    'DISPID_SVSRunningState', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SVSpeakStream', 'DISPID_SpeechAudio',
    'SPFM_OPEN_READONLY', 'ISpeechAudio', 'DISPID_SVEStreamEnd',
    'SPCATEGORYTYPE', 'SAFT44kHz16BitMono',
    'DISPID_SpeechPhraseReplacements', 'ISpeechPhraseElements',
    'SVSFIsNotXML', 'DISPID_SABIBufferSize', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPAsCount', 'SAFT12kHz16BitStereo', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPEEngineConfidence', 'SDTLexicalForm',
    'DISPID_SASCurrentSeekPosition', 'SPVPRI_OVER', 'SPEI_UNDEFINED',
    'SPFM_NUM_MODES', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVSLastBookmarkId', 'SPPS_RESERVED2',
    'eLEXTYPE_RESERVED7', 'SVP_6', 'SP_VISEME_17',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SOTRemove', 'SPEI_SR_PRIVATE',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRGCommit',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPEI_VISEME',
    'SP_VISEME_14', 'DISPID_SDKSetLongValue', 'DISPID_SPRulesCount',
    'SPSHORTCUTTYPE', 'DISPID_SpeechObjectTokens', 'SDTAudio',
    'DISPID_SVWaitUntilDone', 'DISPID_SRGDictationSetState',
    'SpShortcut', 'SPWAVEFORMATTYPE', 'DISPID_SVSInputSentenceLength',
    'ISpNotifySink', 'SPSLMA', 'SRADynamic', 'SpeechTokenValueCLSID',
    'SVEPhoneme', 'DISPID_SADefaultFormat', 'ISpeechGrammarRuleState',
    'SREPropertyStringChange', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRGState', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRCEHypothesis', 'SPRST_ACTIVE_ALWAYS', 'SVEBookmark',
    'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE16', 'SpCompressedLexicon',
    'DISPID_SPRules_NewEnum', 'SAFT11kHz16BitMono', 'SPAO_NONE',
    'DISPID_SRCreateRecoContext', 'DISPID_SRRGetXMLResult', 'SPEVENT',
    'SpMMAudioIn', 'SpPhoneticAlphabetConverter',
    'DISPID_SABufferInfo', 'SPLEXICONTYPE', 'SECFIgnoreWidth',
    'DISPID_SRRTTickCount', 'SLTUser', 'DISPID_SGRsCommit',
    'DISPID_SOTDataKey', 'ISpeechPhraseAlternate', 'SpeechLoadOption',
    'SECHighConfidence', 'SVP_5', 'SpeechPropertyAdaptationOn',
    'DISPID_SBSFormat', 'ISpProperties', 'SPSMF_UPS',
    'SPEI_SR_RETAINEDAUDIO', 'IStream', 'SPSFunction',
    'DISPID_SRSClsidEngine', 'SPEI_SR_BOOKMARK',
    'DISPID_SVAudioOutputStream', 'SRESoundStart',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpRecoGrammar',
    'ISpAudio', 'DISPID_SPRs_NewEnum', 'DISPID_SLPType',
    'SAFT12kHz16BitMono', 'DISPID_SPRuleId',
    'SpStreamFormatConverter', 'DISPID_SGRSTPropertyValue',
    'DISPID_SBSRead', 'SDKLCurrentConfig', 'STCRemoteServer',
    'SP_VISEME_15', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechObjectTokens', 'DISPID_SPPChildren', 'DISPID_SVGetVoices',
    'SAFT16kHz16BitStereo', 'SVP_12', 'SDTRule',
    'DISPID_SMSAMMHandle', 'SPPHRASEREPLACEMENT',
    'SPFM_CREATE_ALWAYS', 'SPSHT_Unknown', 'SAFTGSM610_8kHzMono',
    'DISPID_SRGCmdLoadFromResource', 'SPPHRASEPROPERTY', 'SWTDeleted',
    'ISpeechLexicon', 'SVEEndInputStream', 'SPRST_NUM_STATES',
    'DISPID_SPARecoResult', 'DISPID_SMSALineId', 'SPPS_Modifier',
    'DISPID_SRGIsPronounceable', 'SPDKL_CurrentUser',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVSLastBookmark',
    'DISPID_SVEVoiceChange', 'DISPID_SAFGuid',
    'DISPID_SPEDisplayAttributes', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVSInputWordLength', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVEventInterests', 'DISPID_SVEEnginePrivate',
    'DISPID_SOTGetDescription', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPPARTOFSPEECH', 'ISpPhoneConverter', 'SPBO_PAUSE',
    'ISpeechAudioFormat', 'SPWORDPRONOUNCEABLE',
    'SPTEXTSELECTIONINFO', 'DISPID_SRSetPropertyNumber',
    'SpeechTokenKeyUI', 'SPWT_PRONUNCIATION', 'SpeechRecognizerState',
    'SPPS_LMA', 'SVSFParseAutodetect', 'ISpeechVoice',
    'SpeechTokenShellFolder', 'SVP_18', 'SpeechAudioState',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE8',
    'SPSHORTCUTPAIRLIST', 'SGRSTTEpsilon', 'eLEXTYPE_RESERVED10',
    'SAFT48kHz16BitStereo', 'eWORDTYPE_DELETED', 'SPEI_SOUND_END',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpVoice', 'SPAR_High',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpPhoneticAlphabetSelection', 'STSF_FlagCreate', 'SPWORDLIST',
    'DISPID_SRRAudio', 'DISPID_SAFType', 'ISpeechPhraseReplacements',
    'SAFT32kHz8BitStereo', 'SGSEnabled', 'SVF_None',
    'SPXRO_Alternates_SML', 'SAFT44kHz8BitMono', 'SPBO_NONE',
    'ISpeechLexiconWord', 'ISpeechRecoGrammar', 'ISpRecoGrammar2',
    'DISPID_SRGCmdSetRuleIdState', 'SPSModifier',
    'DISPID_SpeechFileStream', 'DISPID_SASCurrentDevicePosition',
    'SpeechGrammarState', 'STCInprocHandler', 'DISPID_SAStatus',
    'SPVOICESTATUS', 'SPGS_ENABLED', 'SVP_19', 'ISpeechMMSysAudio',
    'DISPID_SPRuleName', 'eLEXTYPE_RESERVED6', 'SPRST_ACTIVE',
    'SPAS_RUN', 'DISPIDSPTSI', 'ISpeechRecoResult2',
    'DISPID_SGRSAddSpecialTransition', 'SpeechEngineConfidence',
    'SpeechGrammarTagDictation', 'SVESentenceBoundary', 'SRSActive',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSEMANTICFORMAT',
    'ISpeechDataKey', 'SPCT_SUB_COMMAND', 'SpeechVoiceEvents',
    'SPWF_SRENGINE', 'SPPS_NotOverriden',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPCIdToPhone',
    'SAFT16kHz16BitMono', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGDictationUnload', 'SpMemoryStream',
    'DISPID_SpeechVoice', 'SVP_2', 'SAFT8kHz16BitStereo',
    'SPRECOGNIZERSTATUS', 'DISPID_SOTCSetId', 'SDTPronunciation',
    'SVEAllEvents', 'DISPID_SPRuleChildren',
    'DISPID_SPERequiredConfidence', 'SFTInput',
    'DISPID_SpeechRecoContextEvents', 'SpeechTokenContext',
    'SPWORDPRONUNCIATIONLIST', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCERecognizerStateChange', 'SVP_21',
    'SPEI_SR_AUDIO_LEVEL', 'SINoSignal', 'DISPID_SOTCGetDataKey',
    'SVP_13', 'SpeechPropertyNormalConfidenceThreshold',
    'SPWORDPRONUNCIATION', 'SpObjectTokenCategory',
    'ISpPhoneticAlphabetConverter', 'SPRULE', 'ISpeechPhoneConverter',
    'DISPID_SVEStreamStart', 'SBOPause', 'DISPID_SRCEAdaptation',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVDisplayUI',
    'DISPID_SRCEBookmark', 'SPPS_Noncontent', 'ISpeechWaveFormatEx',
    'Speech_Max_Pron_Length', 'ISpeechAudioStatus', 'SVSFIsFilename',
    'DISPID_SGRInitialState', 'DISPID_SRCRetainedAudioFormat',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPIGrammarId',
    'SPEI_SENTENCE_BOUNDARY', 'SPDKL_CurrentConfig', 'SPEI_MIN_SR',
    'SLTApp', 'SAFT22kHz8BitStereo', 'SGDSInactive', 'SPGS_DISABLED',
    'SPSSuppressWord', 'DISPID_SRGDictationLoad',
    'ISpeechCustomStream', 'SRSInactiveWithPurge', 'SPAR_Medium',
    'SAFT24kHz16BitStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPRFirstElement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechMMSysAudio',
    'SGRSTTWildcard', 'SAFTCCITT_ALaw_8kHzMono', 'SGSExclusive',
    'SPCT_DICTATION', 'DISPID_SRStatus', 'SVSFParseSapi',
    'SpeechRuleState', 'SpPhraseInfoBuilder',
    'DISPID_SRCERecognitionForOtherContext', 'ISpPhraseAlt',
    'SDTAlternates', 'SGPronounciation', 'SpeechAudioProperties',
    'ISpeechPhraseInfo', 'ISpRecoCategory', 'SpeechTokenKeyFiles',
    'SPPHRASEELEMENT', 'SPGS_EXCLUSIVE', 'SASPause',
    'ISpeechVoiceStatus', 'SPPROPERTYINFO', 'SDKLCurrentUser',
    'SRATopLevel', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SREInterference',
    '_SPAUDIOSTATE', 'DISPID_SpeechRecoResult2',
    'SAFT44kHz16BitStereo', 'DISPID_SRIsUISupported',
    'DISPID_SPIGetDisplayAttributes', 'SpeechUserTraining',
    'SPAR_Unknown', 'DISPID_SLPsItem', 'SPRS_ACTIVE',
    'SpeechAudioVolume', 'SVP_0', 'SpeechAudioFormatGUIDText',
    'SPWF_INPUT', 'SPAS_PAUSE', 'SpeechAllElements',
    'DISPID_SRRRecoContext', 'SVSFPersistXML',
    'SpeechCategoryAppLexicons', 'SPSHORTCUTPAIR',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPRNumberOfElements',
    'SAFTCCITT_ALaw_22kHzMono', 'SpVoice', 'SVP_20',
    'SPADAPTATIONRELEVANCE', 'SpUnCompressedLexicon',
    'DISPID_SVSInputWordPosition', 'SGRSTTWord', 'eWORDTYPE_ADDED',
    'DISPID_SWFEBlockAlign', 'SpeechRecoContextState', 'SPSVerb',
    'SPEI_RECO_OTHER_CONTEXT', 'SRESoundEnd', 'SLOStatic',
    'DISPID_SRGId', 'DISPID_SBSSeek', 'DISPID_SPAPhraseInfo',
    'STSF_CommonAppData', 'ISpeechBaseStream', 'SPEI_MAX_SR',
    'SRAORetainAudio', 'SPEI_PHRASE_START', 'DISPID_SpeechLexicon',
    'SVP_1', 'DISPID_SVVoice', 'DISPID_SLPPartOfSpeech', 'SVP_8',
    'eLEXTYPE_RESERVED9', 'DISPID_SRRSetTextFeedback',
    'SpeechPropertyResponseSpeed', 'SPXMLRESULTOPTIONS',
    'SAFTADPCM_22kHzStereo', 'SpeechAudioFormatType',
    'DISPID_SpeechGrammarRule', 'DISPID_SPRuleNumberOfElements',
    'SAFT12kHz8BitMono', 'DISPID_SOTsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_16',
    'SpNullPhoneConverter', 'DISPID_SOTId', 'SGDSActiveWithAutoPause',
    'SAFT24kHz8BitStereo', 'SpeechRuleAttributes',
    'DISPID_SWFEChannels', 'ISpeechTextSelectionInformation',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SABIMinNotification', 'SSFMOpenForRead',
    'DISPID_SpeechRecoResult', 'DISPID_SOTs_NewEnum',
    'SPINTERFERENCE', 'DISPID_SOTCreateInstance', 'SWTAdded',
    'SREPrivate', '_ISpeechRecoContextEvents', 'SPSHT_EMAIL',
    'DISPID_SLPPhoneIds', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechLexiconProns', 'ISpeechRecoResult',
    'DISPID_SVIsUISupported', 'SpInProcRecoContext', 'SVSFParseSsml',
    'DISPID_SVEWord', 'DISPID_SLWType', 'DISPID_SGRSTsCount',
    'SpObjectToken', 'ISpNotifySource', 'SVEWordBoundary',
    'SPEI_START_INPUT_STREAM', 'SP_VISEME_3', 'SpeechInterference',
    'ISpeechPhraseProperty', 'SPSERIALIZEDRESULT', 'SINoise',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SpeechWaveFormatEx',
    'SAFT8kHz8BitStereo', 'DISPID_SRCSetAdaptationData',
    'SpeechGrammarTagUnlimitedDictation', 'SREStreamStart',
    'Speech_StreamPos_Asap', 'DISPID_SRSetPropertyString',
    'DISPID_SVAlertBoundary', 'DISPID_SASState',
    'DISPID_SRCERequestUI', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPEsItem', 'DISPID_SPAs_NewEnum', 'DISPID_SMSGetData',
    'ISpStreamFormat', 'DISPID_SLWWord', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPIElements', 'SDA_One_Trailing_Space', 'SPAUDIOSTATE',
    'SVSFNLPSpeakPunc', 'SRTEmulated', 'DISPID_SRCCreateGrammar',
    'SDA_Consume_Leading_Spaces', 'SAFTADPCM_11kHzMono',
    'SPINTERFERENCE_TOOFAST', 'SPWORD', 'DISPID_SVEPhoneme',
    'SpWaveFormatEx', 'SP_VISEME_19', 'DISPID_SPPConfidence',
    'SGSDisabled', 'SPBO_TIME_UNITS', 'SRAInterpreter', 'SVP_15',
    'SpeechAudioFormatGUIDWave',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPRST_INACTIVE',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPAsItem',
    'DISPID_SPRsCount', 'DISPID_SDKSetStringValue', 'SRSEDone',
    'ISpeechRecoContext', 'SPEI_TTS_BOOKMARK',
    'SGLexicalNoSpecialChars', 'SP_VISEME_7', 'SITooFast',
    'SP_VISEME_20', 'SPEI_MAX_TTS', 'tagSPPROPERTYINFO',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SRCS_Enabled',
    'SPEI_RESERVED3', 'SWPKnownWordPronounceable',
    'SpeechPropertyResourceUsage', 'SPDATAKEYLOCATION',
    'SRTExtendableParse', 'SpTextSelectionInformation',
    'DISPID_SVSLastResult', 'SSTTTextBuffer', 'DISPID_SVEViseme',
    'DISPID_SPPId', 'DISPID_SWFEExtraData', 'DISPID_SPCLangId',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT32kHz16BitStereo',
    'ISpMMSysAudio', 'SPWT_LEXICAL', 'SpeechCategoryVoices',
    'SPEI_INTERFERENCE', 'DISPID_SRIsShared', 'SPAR_Low',
    'SPSERIALIZEDPHRASE', 'SPCS_ENABLED', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechObjectTokenCategory', 'ISequentialStream',
    'DISPID_SVVolume', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SDKEnumKeys', 'DISPID_SOTsItem', 'ISpeechLexiconWords',
    'SpeechDataKeyLocation', 'SPEI_RESERVED1', 'DISPID_SLGetWords',
    'SRERecoOtherContext', 'SPAS_STOP', 'SPPHRASE', 'DISPID_SVSpeak',
    'ISpResourceManager', 'DISPID_SWFEBitsPerSample', 'ISpLexicon',
    'SITooQuiet', 'DISPID_SpeechAudioBufferInfo',
    'SREFalseRecognition', 'DISPID_SPPValue'
]
